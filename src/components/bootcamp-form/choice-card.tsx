...
export function ChoiceCard({ choice, selected, onSelect }: ChoiceCardProps) {
  return (
    <button
      ...
      className={cn(
        "group relative flex h-full min-h-[200px] flex-col overflow-hidden rounded-2xl bg-[#F5F1E6] p-4 text-left transition-[transform,box-shadow,border-color] duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#FF774F] focus-visible:ring-offset-2 sm:min-h-[220px] sm:rounded-[20px] sm:p-5",
        selected
